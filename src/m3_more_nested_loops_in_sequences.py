...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 6
    answer = largest_number(([5, 6], [-1111111111111111], [4]))
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = 100
    answer = largest_number(([2], [-1111111111111111], [100, 50]))
    print('Expected and actual are:', expected, answer)
...
def largest_number(seq_seq):
    ...
    for j in range(len(seq_seq)):
        if len(seq_seq[j]) > 0 and (maximum == 'None'):
            maximum = seq_seq[j][0]
        if len(seq_seq[j]) > 0:
...
def run_test_largest_negative_number():
    ...
    # Test 4:
    expected = -15
    answer = largest_negative_number(([-5, 6], [-11, -15, 5], [4, -10]))
    print('Expected and actual are:', expected, answer)

    # Test 5:
    expected = -11
    answer = largest_negative_number(([], [-11], [100, 50]))
    print('Expected and actual are:', expected, answer)
